...
Date Source: [https://www.kaggle.com/datasets/pavansubhasht/ibm-hr-analytics-attrition-dataset](https://www.kaggle.com/datasets/pavansubhasht/ibm-hr-analytics-attrition-dataset/)
...
This project served as a crucial step in re-establishing my proficiency with Tableau, marking my return to the platform after a nearly **15-year hiatus** in my 23-year data analysis career. My primary objective was capability restoration; specifically, demonstrating mastery of current Tableau functionality, modern data connectivity, and calculation handling.

While the visual design intentionally referenced established community patterns for the widely-used IBM attrition dataset (allowing me to focus on the 'how' rather than the 'what'), the project successfully delivered a complex, single-page analysis. Crucially, this exercise affirmed my ability to quickly adapt core analytical principles to contemporary BI tools, significantly boosting my confidence in leveraging Tableau for future engagements.
